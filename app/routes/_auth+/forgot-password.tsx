...
export async function action({ request }: Route.ActionArgs) {
	...
	const response = await sendEmail({
		to: user.email,
		subject: `Dinner Not On Your Own Password Reset`,
...
function ForgotPasswordEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Dinner Not On Your Own Password Reset</E.Text>
				</h1>
				<p>
					<E.Text>
...
export const meta: Route.MetaFunction = () => {
	return [{ title: 'Password Recovery for Dinner Not On Your Own' }]
}
